...
public class InertialPoint {
    ...
    public static InertialPoint move(InertialPoint inertialPoint, InertialData inertialData, long timestamp) {
        ...
        if (currentInertialPoint.count < 130) {
        ...
        Logging.printLine(currentInertialPoint.toString());
