...
public class DisplayRoute {
    ...
    private final static Color TRIAL_COLOR = Color.RED;
    private final static Color FINAL_COLOR = Color.BLUE;       
    
    public static void draw(List<Point> trialPoints, List<Point> finalPoints, File routeFile, File floorPlanFile) {
