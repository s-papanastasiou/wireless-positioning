...
import com.example.Filter.Cloud;
import com.example.Filter.Particle;
import com.example.Filter.ParticleFilter;
import com.example.ProbabilisticMethod.Probabilistic;
            ...
            if (success) {
                ...
                if (!isInitialising) {
                    ...
                    if (invert) {
                        ...
                        InertialData results = InertialData.getDatas(iR, mLinearAcceleration, orientation, appSettings.getBuildingOrientation());
                        inertialPoint = InertialPoint.move(inertialPoint, results, System.nanoTime());
