...
public class KNNTrial4 extends TestCase {
    ...
    public void testRSSIUnmerged() {
        ...
        for (int i = lowerTrialPaths; i <= upperTrialPaths; i++) {
            ...
            KNNTrialSettings trialSettings = new KNNTrialSettings(lowerKValue, upperKValue, isBSSIDMerged, isEstimateImages, locateStyle);
    ...
    public void testGeomagnetic() {
        ...
        for (int i = lowerTrialPaths; i <= upperTrialPaths; i++) {
            ...
            KNNTrialSettings trialSettings = new KNNTrialSettings(lowerKValue, upperKValue, false, isEstimateImages, locateStyle);
