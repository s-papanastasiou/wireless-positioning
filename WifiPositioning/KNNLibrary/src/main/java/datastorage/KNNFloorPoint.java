 ...
 * 
 * Generic container to store either Magnetic or RSSI data.
 * Key would be X,Y or Z for Magnetic and the BSSID for RSSI.
 * Value would be microTesla for Magnetic and dbm for RSSI.
 * 
 */
public class KNNFloorPoint extends Location implements Serializable {
    ...
    /**
     * KNNFloorPoint constructor
     * @location Location of the floor point.
     */
